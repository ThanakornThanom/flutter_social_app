class ChannelList {
	...
	ChannelList.fromJson(Map<String, dynamic> json) {
		if (json['channels'] != null) {
			channels = <Channels>[];
			json['channels'].forEach((v) { channels!.add(new Channels.fromJson(v)); });
		}
		if (json['channelUsers'] != null) {
			channelUsers = <ChannelUsers>[];
			json['channelUsers'].forEach((v) { channelUsers!.add(new ChannelUsers.fromJson(v)); });
		}
		if (json['users'] != null) {
			users = <Users>[];
		...
		if (json['files'] != null) {
			files = <Files>[];
			json['files'].forEach((v) { files!.add(new Files.fromJson(v)); });
		}
	}
...
class Channels {
	...
	Channels({this.channelId, this.isDistinct, this.metadata, this.type, this.tags, this.isMuted, this.isRateLimited, this.muteTimeout, this.rateLimit, this.rateLimitWindow, this.rateLimitTimeout, this.displayName, this.messageAutoDeleteEnabled, this.autoDeleteMessageByFlagLimit, this.memberCount, this.messageCount, this.lastActivity, this.createdAt, this.updatedAt, this.avatarFileId, this.isDeleted});
...
class ChannelUsers {
	...
	ChannelUsers({this.userId, this.channelId, this.membership, this.isBanned, this.lastActivity, this.roles, this.permissions, this.readToSegment, this.lastMentionedSegment, this.isMuted, this.muteTimeout, this.createdAt, this.updatedAt});
...
class Users {
	...
	Users({this.sId, this.path, this.userId, this.roles, this.permissions, this.displayName, this.description, this.avatarFileId, this.avatarCustomUrl, this.flagCount, this.hashFlag, this.metadata, this.isGlobalBan, this.createdAt, this.updatedAt});
	...
	Users.fromJson(Map<String, dynamic> json) {
		...
		hashFlag = json['hashFlag'] != null ? new HashFlag.fromJson(json['hashFlag']) : null;
		metadata = json['metadata'] != null ? new Metadata.fromJson(json['metadata']) : null;
	...
	Map<String, dynamic> toJson() {
		...
		if (this.hashFlag != null) {
      data['hashFlag'] = this.hashFlag!.toJson();
    }
		if (this.metadata != null) {
      data['metadata'] = this.metadata!.toJson();
    }
...
class HashFlag {
	...
	HashFlag({this.bits, this.hashes, this.hash});

	HashFlag.fromJson(Map<String, dynamic> json) {
		bits = json['bits'];
		hashes = json['hashes'];
		hash = json['hash'].cast<int>();
	}
...
class Files {
	...
	Files({this.fileId, this.fileUrl, this.type, this.createdAt, this.updatedAt, this.attributes});
...
class FileMetadata {
	...
	FileMetadata.fromJson(Map<String, dynamic> json) {
		exif = json['exif'] != null ? new FileMetadata.fromJson(json['exif']) : null;
